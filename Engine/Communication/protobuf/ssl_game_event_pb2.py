...
_GAME_EVENT_GAMEEVENTTYPE = _descriptor.EnumDescriptor(
  name='GameEventType',
  full_name='Game_Event.GameEventType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_sym_db.RegisterEnumDescriptor(_GAME_EVENT_GAMEEVENTTYPE)

_GAME_EVENT_TEAM = _descriptor.EnumDescriptor(
  name='Team',
  full_name='Game_Event.Team',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_GAME_EVENT_TEAM)


_GAME_EVENT_ORIGINATOR = _descriptor.Descriptor(
  name='Originator',
  full_name='Game_Event.Originator',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='team', full_name='Game_Event.Originator.team', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='botId', full_name='Game_Event.Originator.botId', index=1,
...
_GAME_EVENT = _descriptor.Descriptor(
  name='Game_Event',
  full_name='Game_Event',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='gameEventType', full_name='Game_Event.gameEventType', index=0,
      number=1, type=14, cpp_type=8, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='originator', full_name='Game_Event.originator', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='message', full_name='Game_Event.message', index=2,
  ...
  nested_types=[_GAME_EVENT_ORIGINATOR, ],
  enum_types=[
    _GAME_EVENT_GAMEEVENTTYPE,
    _GAME_EVENT_TEAM,
  ],
  options=None,
  is_extendable=False,
...
_GAME_EVENT_ORIGINATOR.fields_by_name['team'].enum_type = _GAME_EVENT_TEAM
_GAME_EVENT_ORIGINATOR.containing_type = _GAME_EVENT
_GAME_EVENT.fields_by_name['gameEventType'].enum_type = _GAME_EVENT_GAMEEVENTTYPE
_GAME_EVENT.fields_by_name['originator'].message_type = _GAME_EVENT_ORIGINATOR
_GAME_EVENT_GAMEEVENTTYPE.containing_type = _GAME_EVENT
_GAME_EVENT_TEAM.containing_type = _GAME_EVENT
DESCRIPTOR.message_types_by_name['Game_Event'] = _GAME_EVENT

Game_Event = _reflection.GeneratedProtocolMessageType('Game_Event', (_message.Message,), dict(

  Originator = _reflection.GeneratedProtocolMessageType('Originator', (_message.Message,), dict(
    DESCRIPTOR = _GAME_EVENT_ORIGINATOR,
    __module__ = 'ssl_game_event_pb2'
    # @@protoc_insertion_point(class_scope:Game_Event.Originator)
    ))
  ,
  DESCRIPTOR = _GAME_EVENT,
  __module__ = 'ssl_game_event_pb2'
  # @@protoc_insertion_point(class_scope:Game_Event)
  ))
_sym_db.RegisterMessage(Game_Event)
_sym_db.RegisterMessage(Game_Event.Originator)
