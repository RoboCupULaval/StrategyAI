...
def get_distance(position_1: Position, position_2: Position) -> float:
    ...
    warnings.warn('(position_1 - position_2).norm() should be use instead.', stacklevel=1)
...
def get_angle(main_position: Position, other: Position) -> float:
    ...
    warnings.warn('(position_1 - position_2).angle() should be use instead.', stacklevel=1)
