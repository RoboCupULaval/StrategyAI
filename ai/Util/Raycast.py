...
def raycast(info_manager, initial_position, length, direction, width, player_to_ignore, is_ball_ignored=True):
    ...
    assert isinstance(player_to_ignore, int)
    ...
    return raycast2(info_manager, initial_position, final_position, width, player_to_ignore, is_ball_ignored)


def raycast2(info_manager, initial_position, final_position, width, player_to_ignore, is_ball_ignored=True):
    assert isinstance(info_manager, InfoManager)
    assert isinstance(initial_position, Position)
