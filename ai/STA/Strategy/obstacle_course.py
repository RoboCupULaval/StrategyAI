...
class ObstacleCourse(Strategy):
    ...
    def __init__(self, p_game_state):
        ...
        self.add_condition(4, 0, 1, partial(self.condition, 4))
        ...
        # self.add_tactic(0, GoToPositionNoPathfinder(self.game_state, 4, Pose(Position(x_left/2, y_top))))
        # self.add_tactic(0, GoToPositionNoPathfinder(self.game_state, 4, Pose(Position(x_left/2, y_down))))
