...
class WeirdmovementStrategy(Strategy):
    ...
    def __init__(self, p_game_state):
        ...
        self.graphs[1].add_vertex(0, 1, self.condition1)
        self.graphs[1].add_vertex(1, 2, self.condition1)
        self.graphs[1].add_vertex(2, 3, self.condition1)
        self.graphs[1].add_vertex(3, 0, self.condition1)
